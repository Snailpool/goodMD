		...
		return (
			<div style={{ height: '100%' }}>
				<div className="editor">
					<div className={ this.state.helper ? 'helper' : 'helper helper--hide' }>
						<button className="helper__btn" onClick={ this.append.bind(this, 'link') }>連結</button>
						<button className="helper__btn" onClick={ this.append.bind(this, 'table') }>表格</button>
						<button className="helper__btn" onClick={ this.append.bind(this, 'code') }>程式碼</button>
						<button className="helper__btn" onClick={ this.append.bind(this, 'image') }>圖片</button>
						<button className="helper__btn" onClick={ this.append.bind(this, 'video') }>youtube影片</button>
						<span className="helper__hint" onClick={ this.toggleHelper.bind(this) }>help !</span>
					</div>
					<textarea id="inputTextarea" onClick={this.parseMarkdown.bind(this)} onChange={this.parseMarkdown.bind(this) } className="editor__textarea" defaultValue={this.state.defaultText} ref="markdown"></textarea>
				</div>
